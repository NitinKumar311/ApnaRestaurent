...
const FoodListing = () => {
  ...
  const getFilteredProductsData = async () => {
    ...
    if (priceRange[1] < 100) {
      // Check if the price range is too low
      setErrorMessage("No products available in this range. Please select a Price Range of $100 or Above.");
      setProducts([]); // Clear products if no valid data
      setLoading(false);
      return;
    }
